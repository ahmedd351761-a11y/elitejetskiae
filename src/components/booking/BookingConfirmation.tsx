    ...
    <div className="max-w-3xl mx-auto pt-8">
      <div className="bg-white rounded-2xl shadow-2xl p-8 sm:p-12 text-center">
        ...
        <p className="text-xl text-gray-600 mb-8">
          Your jet ski adventure is all set
        </p>
          ...
          <div className="bg-amber-50 border-2 border-amber-400 rounded-xl p-4 mb-6 flex items-start gap-3">
            ...
            <div className="text-left">
              ...
              <p className="text-amber-700 text-sm">
                Please contact us on WhatsApp to finalize your booking and arrange payment.
              </p>
            </div>
          </div>
        )}
        ...
        <div className="bg-gradient-to-r from-[#E31E24]/10 to-[#0A1128]/10 rounded-2xl p-8 mb-8 border-2 border-[#E31E24]">
          <p className="text-sm text-gray-600 mb-2 uppercase tracking-widest font-semibold">Booking Reference</p>
          ...
          {whatsappSent ? (
            <>
              <div className="flex items-center justify-center gap-3 mb-3">
                ...
                <p className="text-green-900 font-bold text-lg">WhatsApp Sent Successfully!</p>
              </div>
              <p className="text-green-700 text-sm">
                Our team will respond shortly with payment details and confirmation.
              </p>
            </>
          ) : (
            <>
              ...
              <div className="flex items-center justify-center gap-3 mb-3">
                ...
                <p className="text-green-900 font-bold text-lg">Complete Your Booking via WhatsApp</p>
              </div>
              <p className="text-green-800 text-sm leading-relaxed">
                <strong>Required:</strong> Send your booking details to our team via WhatsApp to finalize your reservation and arrange payment (bank transfer or cash on arrival).
              </p>
            </>
          )}
        </div>
        ...
        <div className="space-y-3 mb-8">
          ...
          >
            <Send size={24} />
            <span className="text-lg">{whatsappSent ? '✓ Booking Sent to WhatsApp' : '📲 Send Booking via WhatsApp'}</span>
          </button>
          
          {!whatsappSent && (
            <p className="text-center text-sm text-gray-500">
              Click above to open WhatsApp with your booking details pre-filled
            </p>
          )}
        ...
        <div className="border-t border-gray-200 pt-8">
          <h3 className="text-xl font-bold text-[#0A1128] mb-6">What to Bring</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-left max-w-2xl mx-auto mb-8">
            ...
            <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
              <CheckCircle size={20} className="text-green-600 flex-shrink-0 mt-1" />
              <span className="text-gray-700">Sunscreen and sunglasses</span>
            </div>
            <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
              <CheckCircle size={20} className="text-green-600 flex-shrink-0 mt-1" />
              <span className="text-gray-700">Towel and change of clothes</span>
            </div>
            <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
              <CheckCircle size={20} className="text-green-600 flex-shrink-0 mt-1" />
              <span className="text-gray-700">Waterproof camera (optional)</span>
            </div>
          </div>
        </div>

        <div className="mt-8 pt-8 border-t border-gray-200">
          <h3 className="text-xl font-bold text-[#0A1128] mb-6">Location & Directions</h3>
